...
func (m *MockCommentRepository) Get(ctx context.Context, input repository.GetCommentInput) (entity.Comments, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCommentRepositoryMockRecorder) Get(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockCommentRepository)(nil).Get), ctx, input)
}
